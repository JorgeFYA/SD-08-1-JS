...
switch (task) {
  ...
  case 5:
    ...
    const player5 = new Player('Grog', 4, 10);
    console.log(player5);
    break;
  case 6:
    globalThis.Player = task6.Player;
    const dummy = new Player('Jhon', 1, 0);
    const dummy2 = new Player('Doe', 1, 0, dummy);
    const player6 = new Player('Grog', 4, 10, [dummy, dummy2]);
    console.log(player6);
    break;
  case 7:
    globalThis.Player = task7.Player;
    //const player7 = new Player('Grog', 4, 10);
    const player7 = new Player('Grog', 4, 10, [{ potion: 3 }, { sword: 1 }, { shield: 1 }]);
    console.log(player7);
    //player7.createItemList();
    player7.deleteObjectFromInventory(2);
    console.log(player7);
    player7.addObjectToInventory({ bow: 1 });
    player7.showInventory();
}
